...
PROFILE_PIC_FOLDER = 'static/uploads/admin/profile_pics'
VALID_ID_FOLDER = 'static/uploads/admin/valid_id_pic'
...
def settings():
    ...
    personal_info = get_personal_info(admin_id)
    address_info = get_address_info(admin_id)
    contact_info = get_contact_info(admin_id)
    valid_info = get_valid_info(admin_id)
...
@admin_settings_bp.route('/admin/settings/update-personal', methods=['POST'])
def update_personal_info():
    ...
    try:
        ...
        cursor.execute("SELECT personal_id FROM user_account WHERE user_id = %s", (admin_id,))
...
@admin_settings_bp.route('/admin/settings/update-address', methods=['POST'])
def update_address_info():
    ...
    try:
        ...
        cursor.execute("SELECT address_id FROM user_account WHERE user_id = %s", (admin_id,))
        result = cursor.fetchone()
...
@admin_settings_bp.route('/admin/settings/update-contact', methods=['POST'])
def update_contact_info():
    ...
    try:
        ...
        cursor.execute("SELECT contact_id FROM user_account WHERE user_id = %s", (admin_id,))
        result = cursor.fetchone()
...
@admin_settings_bp.route('/admin/settings/update-valid-id', methods=['POST'])
def update_valid_id():
    if 'admin' not in session:
        return jsonify({'success': False, 'message': 'Unauthorized access'})
    ...
    try:
        ...
        cursor.execute("SELECT valid_id FROM user_account WHERE user_id = %s", (admin_id,))
        result = cursor.fetchone()
...
@admin_settings_bp.route('/admin/settings/change-password', methods=['POST'])
def change_password():
    if 'admin' not in session:
        return jsonify({'success': False, 'message': 'Unauthorized access'})
...
@admin_settings_bp.route('/admin/settings/update-profile-pic', methods=['POST'])
def update_profile_pic():
    ...
    try:
        ...
        cursor.execute("SELECT profile_pic FROM user_account WHERE user_id = %s", (admin_id,))
        result = cursor.fetchone()
...
@admin_settings_bp.route('/admin/settings/profile_pics/<filename>')
def serve_profile_pic(filename):
    return send_from_directory(PROFILE_PIC_FOLDER, filename)

@admin_settings_bp.route('/admin/settings/valid_ids/<filename>')
